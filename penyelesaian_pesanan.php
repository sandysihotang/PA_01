...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <ul class="nav nav-pills">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="penyelesaian_pesanan.php"><i class="fa fa-binoculars"></i> Penyelesaian
                Pesanan</a>
        </li>
    ...
    <table class="table table-striped img-thumbnail">
        ...
        while ($pesanan = mysqli_fetch_object($all)) {
            ...
            <tr>
                ...
                <td><a href="lihat_pesanan_konfirmasi.php?id=<?= $pesanan->id ?>"
                       class="btn btn-primary btn-sm">LOOK</a></td>
                <td><a href="penyelesaian_pesanan.php?id=<?= $pesanan->id ?>&jenis=atm" class="btn btn-success btn-sm">SELESAI</a>
                </td>
                <td></td>
            </tr>
            <?php $i++;
