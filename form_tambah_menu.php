...
<?php if (base64_decode($_GET['jenis']) == 'makanan') { ?>
    <div class="container img-thumbnail alert alert-info text-black">
        <div class="row">
            <div class="col-md-12">
                <div class="product">
                    <h3 align="center">Tambah Makanan</h3>
                    ...
                    <form action="tambah.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="text-center">
                            <button name="tambah_makanan" type="submit" class="btn btn-komentar btn-md"><i
...
<?php } else { ?>
    ...
    <div class="container img-thumbnail alert alert-info">
        <div class="row">
            <div class="col-md-12">
                <div class="product">
                    <h3 align="center">Tambah Minuman</h3>
                    <hr class="pg-titl-bdr-bte"></hr>
                    ...
                    <form action="tambah.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="text-center">
                            <button name="tambah_minuman" type="submit" class="btn btn-komentar btn-md"><i
                                        class="fa fa-plus"></i>Tambah
                            </button>
                        </div>
                    </form>
