...
?>
    ...
    <div class="container img-thumbnail alert alert-info">
        <div class="row">
            <div class="col-md-12">
                <div class="product">
                    <h3 align="center">Update Minuman</h3>
                    <hr class="pg-titl-bdr-bte"></hr>
                    <?php
                    $data = new menu;
                    ...
                    <form action="tambah.php?id=<?= $_GET['id'] ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <p>Nama Minuman</p>
                            <input type="text" name="nama_minuman" value="<?= $makanan['nama_minuman'] ?>"
                                   class="form-control" required/>
                        </div>
                        <div class="form-group">
                            <p>Harga Minuman</p>
                            <input type="number" name="harga" value="<?= $makanan['harga'] ?>" class="form-control"
                                   required/>
                        </div>
                        <div class="form-group">
                            <p>Deskripsi</p>
                            <textarea name="deskripsi" class="form-control"
                                      placeholder="Deskripsi Minuman"><?= $makanan['deskripsi'] ?></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="text-center">
                            <button name="update_minuman" type="submit" class="btn btn-md"><i class="fa fa-plus"></i>Update
                            </button>
                        </div>
                    </form>
                </div>
