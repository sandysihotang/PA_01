...
if ($account->get_session('is_logged_in') && $account->get_session('user') == 2) { ?>
    <button type="button" data-toggle="modal" data-target="#Modal" class="btn btn-success">Tambah Informasi <i
            ...
            <div class="modal-body">
                ...
                <div id="accordion" role="tablist">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                            <div class="card-body">
                                <form action="tambah_informasi.php" method="post" class="form-signin"
                                      enctype="multipart/form-data">
                                    <h2>Insert Informasi</h2>
                                    <label>Judul</label>
                                    <input type="text" name="judul" class="form-control">
                                    <label>Text</label>
                                    <textarea class="form-control" required autofocus name="text"
                                              placeholder="Deskripsi"></textarea><br>
                                    <label>Gambar</label>
                                    <input type="file" name="gambar" class="form-control" required autofocus><br>
                                    <button class="btn btn-primary btn-block" type="submit" name="tambah_infromasi"><i
...
while ($info = mysqli_fetch_object($informasi)) {
    if ($i % 2 == 1) {
        ...
        <div class="container bg-light">
            ...
            <div class="row">
                <p align="justify"><img src="img/informasi/<?= $info->gambar ?>" class="informasi wow rollIn mr-3"
                                        data-wow-offset="0" data-wow-delay="0.5s"><i><?= $info->deskripsi ?></i></p>
            </div>
    ...
    <?php } else if ($i % 2 == 0) { ?>
        <div class="container bg-light">
            <h3><i><b><?= $i . '. ' . $info->Judul ?></b></i></h3>
            <div class="row">
                <p align="justify"><img src="img/informasi/<?= $info->gambar ?>" class="informasi1 wow rollIn"
                                        data-wow-offset="0" data-wow-delay="0.5s"><i><?= $info->deskripsi ?></i></p>
            </div>
            <?php if (isset($_SESSION['is_logged_in']) && $_SESSION['id'] == 1) { ?>
                <a href="about.php?id=<?= $info->id ?>" class="btn btn-danger">Delete</a>
