...
<div class="  alert-secondary" align=center><h1>GALERY GASTRO SIJABU JABU</h1><br>
    ...
    if ($account->get_session('is_logged_in') && $account->get_session('user') == 2) { ?>
        <button type="button" data-toggle="modal" data-target="#Modal" class="btn btn-success">Tambah Gambar <i
            ...
            <div class="modal-body">
                ...
                <div id="accordion" role="tablist">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                            <div class="card-body">
                                <form action="tambah_galery.php" method="post" class="form-signin"
                                      enctype="multipart/form-data">
                                    <h2>Insert Gambar</h2>
                                    <label for="inputEmail" class="sr-only">Deskripsi</label>
                                    <textarea class="form-control" required autofocus name="deskripsi"
                                              placeholder="Deskripsi"></textarea><br><br>
                                    <label for="inputPassword" class="sr-only">Gambar</label>
                                    <input type="file" name="gambar" class="form-control" required autofocus
                                           placeholder="Password"><br>
                                    <button class="btn btn-primary btn-block" type="submit" name="tambah_galery"><i
                ...
                <div class="col-md-3 wow bounceIn" data-wow-offset="0" data-wow-delay="0.8s">
                    ...
                    <div class="col-md-3 wow bounceIn" data-wow-offset="0" data-wow-delay="1.2s">
                        ...
                        <div class="card" align="center">
                            <img src="img/galery/<?= $mygalery['img'] ?>" class="img-thumbnail img"
                                 alt="Card image cap">
                        ...
                        <?php if (isset($_SESSION['is_logged_in']) && $account->get_session('user') == 2) { ?>
                            <div align="center">
                                <a href="delete.php?id=<?= $mygalery['id'] ?>&jenis=galery" class="btn btn-danger">Delete
                                    Image</a>
                            </div>
                        <?php } ?>
                    </div>
            ...
            <div class="container-fluid bg-dark text-white jumbotron" style="opacity: 0.8;">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <p>Website Resto yang berada di : Pasar Siborong-Borong, Siborong-Borong, North Tapanuli
                            Regency, North Sumatra 22474</p>
                    </div>
                    <div class="col-md-4">
                        <!-- <h2>Developer:</h2>
