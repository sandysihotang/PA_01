...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <ul class="nav nav-pills">
        <?php if ($_SESSION['user'] == 1 || $_SESSION['user'] == 2) { ?>
            ...
            <li class="nav-item">
                <a href="list_transaksi_manual.php" class="nav-link"><i class="fa fa-user"></i> List Transaksi
                    Manual</a>
            </li>
        <?php } ?>
    </ul>
...
<?php
$data = new pemesanan;
$data_saya = $data->pesan_minuman($_GET['id']);
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form method="post" action="add_to_chart.php?id=<?= $_GET['id'] ?>&jenis=minuman">
                <input type="number" name="jumlah_porsi" class="form-control" min="1" required><br>
                <button type="submit" class="btn btn-primary" name="lanjutkan">Lanjutkan <i
