...
$head->top("Meja");
 ?>
  ...
  <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle  active" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-list"></i> Pesan</a>
            ...
            <div class="col-sm-6">
                <form method="post" action="add_meja.php">
                  ...
                  <div align="center">
                    ...
                    <button type="submit" class="btn btn-success" name="pesan"><i class="fa fa-plus"></i> Pesan Meja</button>
                    <?php }?>
                  </div><br>
                </form>
              </div>
